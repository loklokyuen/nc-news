...
export default function NavBar({ activePage }) {
    ...
    return <div className="bg-surface max-w-xl mx-auto py-1">
          <NavLink to="/">
        ...
        <nav className="nav-bar flex flex-row items-center justify-center divide-x-3 divide-asparagus-500">
          <NavLink to="/articles">
            <span className={`h-8 m-1 tertiary-interactive ${activePage === "articles"? "underline": null}`}>Articles</span>
          </NavLink>
          <NavLink to="/topics">
            <span className={`h-8 m-1 tertiary-interactive ${activePage === "topics"? "underline": null}`}>Topics</span>
          </NavLink>
          <NavLink to="/articles/add">
            <span className={`h-8 m-1 tertiary-interactive ${activePage === "new-article"? "underline": null}`}>New Article</span>
          </NavLink>
