...
export default function NewTopic({ setCreateNewTopic, onTopicCreated }){
    ...
    return <section className="flex flex-col items-center rounded-2xl  bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        <h2 className="font-extrabold text-2xl p-4 text-shadow-green-600">Create a new topic</h2>
        <div className="flex flex-row items-center">
            <label htmlFor="new-topic-slug" className="text-highland-600 font-bold p-1 m-1">Slug: </label>
        ...
        <div className="flex flex-row items-center">
            <label htmlFor="new-topic-description" className="text-highland-600 font-bold p-1 m-1">Description: </label>
            <input id="new-topic-description" name="new-topic-description" type="text" value={description} 
            className="p-1 m-1 border-b-1 text-highland-600 " placeholder="(optional)"
        ...
        { errorMessage && <div className={`message max-w-3xl text-mandys-pink-500 `}>
